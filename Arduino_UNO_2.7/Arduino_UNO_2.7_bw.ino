/***************************************************************************************
 * Project  :
 * Experimental Platform :Arduino UNO + 2.7inch E-Paper Display
 * Hardware Connection :Arduino UNO-> 2.7inch E-Paper
 *      D11 --> CS
 *      D12 --> CLK
 *      D13 --> MOSI
 *      D10  --> DC
...
//////////////////////Partial refresh digital presentation//////////////////////////////////////  
    ...
    for(i=0;i<10;i++)
    {
        EPD_Dis_Part(64,141,Num[i],32,64); //x,y,DATA,resolution 32*64
    }
    delay(2000);   
  ////////////////////////////////////////////////////////////////////////  
      //Clean
