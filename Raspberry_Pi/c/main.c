			...
			for(Fen_L=0;Fen_L<10;Fen_L++)
			{
				for(Miao_H=0;Miao_H<6;Miao_H++) 	
				{
					for(Miao_L=0;Miao_L<10;Miao_L++)
					{
						 ...
						 EPD_Dis_Part_myself(64,76,Num[Miao_L],  //x-A,y-A,DATA-A
											64,110,Num[Miao_H],         //x-B,y-B,DATA-B
											64,150,gImage_numdot,      //x-C,y-C,DATA-C
											64,190,Num[Fen_L],         //x-D,y-D,DATA-D
											64,222,Num[Fen_H],32,64);	 //x-E,y-E,DATA-E,Resolution 32*64 
                         delay(500);
...
Clear:
		...
		Gui_Draw_Str(40, 70, "2.7\" E-Paper", &Font20, WHITE, BLACK); //14*20
