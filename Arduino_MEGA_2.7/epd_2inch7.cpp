...
void EPD_HW_Init_GUI(void)
{
  ...
  Epaper_Write_Data(0x15);    //0x0C-->(21+1)*8=128

  Epaper_Write_Command(0x45); //set Ram-Y address start/end position          
  Epaper_Write_Data(0x07);    //0xF9-->(263+1)=264
  Epaper_Write_Data(0x01);
  Epaper_Write_Data(0x00);
  Epaper_Write_Data(0x00); 
  ...
  Epaper_Write_Data(0x00);
  Epaper_Write_Command(0x4F);   // set RAM y address count to 264;    
  Epaper_Write_Data(0x07);
  Epaper_Write_Data(0x01);
  Epaper_READBUSY();
...
void EPD_Dis_Part(unsigned int x_start,unsigned int y_start,const unsigned char * datas,unsigned int PART_COLUMN,unsigned int PART_LINE)
{
  ...
  Epaper_Write_Data(x_end);    // RAM x address end at 0fh(21+1)*8->128 
